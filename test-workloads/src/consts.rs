...
pub const NUM_GUEST_DATA_PAGES: u64 = 0x100;
pub const GUEST_ZERO_PAGES_START_ADDRESS: u64 =
    USABLE_RAM_START_ADDRESS + NUM_GUEST_DATA_PAGES * PAGE_SIZE_4K;
// 8030 0000

pub const NUM_GUEST_ZERO_PAGES: u64 = 0x100;
pub const PRE_FAULTED_ZERO_PAGES: u64 = 0x10;
...
pub const NUM_GUEST_SHARED_PAGES: u64 = NUM_GUEST_ZERO_PAGES;
